    ...
    public partial class dbs : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", "861244cc-1995-4560-804b-2f5f2a8f4f79", "Admin", null },
                    { "2", "263c0f85-4d85-4837-83e2-6d9a464dc81c", "User", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "dea12856-c198-4129-b3f3-b893d8395082", 0, "746602ef-c6fc-4979-9fda-79f82d397b2d", "Bulgaria", new DateTime(2022, 12, 7, 21, 0, 26, 687, DateTimeKind.Local).AddTicks(4850), null, "agent@mail.com", false, "Ivan", false, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Petrov", false, null, "agent@mail.com", "ivancho", "AQAAAAEAACcQAAAAEGQydIg383Dr8EupaIK/ZfoCM+ikEF5qJr+3DK7GhX85m4n9JUPAPep+Nnd3g030kw==", null, false, "d5048077-31b1-4ddc-b013-f0267494b860", false, "ivancho" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 6, "Pros: Rubber base, hold handle, suitable for multiple ages. Cons: Shallow seat, low splash guardSimple, sturdy, and easy to clean, this toddler toilet that has exactly what you need and no more.", "https://m.media-amazon.com/images/I/71XDXNt9n5L._SL1500_.jpg", "OXO Tot Potty Chair", 25.99m, 0.00m, null },
                    { 2, 6, "Pros: Deep bowl, convenient size, breeze to cleanCons: Limited age range, backlessSmall and functional potty that is perfect for budget minded parents", "https://m.media-amazon.com/images/I/61+uuyDhAcL._SL1500_.jpg", "BabyBjörn Smart Potty", 22.99m, 0.00m, null },
                    { 3, 6, "Adjustable, easy storage, one piece. Toilet needed, assistance needed. Space saving and portable potty seat great for small bathrooms and travel.", "https://m.media-amazon.com/images/I/716ccNgQUSL._SX466_.jpg", "BabyBjörn Toilet Trainer", 34.99m, 0.00m, null },
                    { 4, 6, "Secure sitting area, soft on bottom, easy to store.Not for every toilet, noticeable wear over time.Cushy on-toilet trainer contoured to fit little bums.", "https://m.media-amazon.com/images/I/716ccNgQUSL._SX466_.jpg", "Dreambaby Soft Touch Potty Seat", 24.98m, 0.00m, null }
                });
